...

      {
        !isHideSendInput && (
          <div className="fixed z-10 bottom-0 left-1/2 transform -translate-x-1/2 pc:ml-[122px] tablet:ml-[96px] mobile:ml-0 pc:w-[794px] tablet:w-[794px] max-w-full mobile:w-full px-3.5">
            ...
            <div className="p-2 max-h-[150px] bg-white border border-gray-200 rounded-2xl shadow-sm overflow-y-auto transition-all focus-within:border-blue-300 focus-within:shadow-md">
              ...
              <Textarea
                className={`
                  block w-full px-3 pr-[118px] py-2 leading-6 max-h-none text-base text-gray-700
                  outline-none appearance-none resize-none bg-transparent
              ...
              <div className="absolute bottom-2 right-6 flex items-center h-8">
                ...
                <div className={`${s.count} mr-3 h-5 leading-5 text-sm bg-gray-50 text-gray-500 px-2 rounded`}>
                  {query.trim().length}
                </div>
